...
and will be removed in future versions of Git Town.`
	...
	SyncAllStrategyOverrideNotSupported = "sync doesn't support --all and --strategy flags at the same time"
	...
	SyncStackStrategyOverrideNotSupported = "sync doesn't support --stack and --strategy flags at the same time"
